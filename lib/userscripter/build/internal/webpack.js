...
const tsconfig_paths_webpack_plugin_1 = __importDefault(
...
function createWebpackConfig(x) {
  ...
  return {
    ...
    devtool:
      mode === mode_1.Mode.production ? "hidden-source-map" : "eval-source-map",
    stats: {
      depth: false,
      hash: false,
      modules: false,
          ...
          loaders: [
            ...
            },
            {
              ...
              options: {
                sassOptions: {
                  functions: {
                    [sass_1.withDartSassEncodedParameters(
                      sassVariableGetter,
                      getGlobal
                    )]: getGlobal
                  }
            ...
            },
            {
              ...
              options: {
                ...
                rules: [
                  {
                    restricted:
                      restrict_imports_loader_1.everythingInPackage(
                        USERSCRIPTER_BUILD
                      ),
                    severity: "fatal",
