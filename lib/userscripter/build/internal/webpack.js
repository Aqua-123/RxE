...
function createWebpackConfig(x) {
    ...
    const { appendDateToVersion, id, mainFile, mode, nightly, now, outDir, rootDir, sassVariableGetter, sassVariables, sourceDir, verbose } = overridden.buildConfig;
    ...
    return {
        ...
        devtool: mode === mode_1.Mode.production ? "hidden-source-map" : "eval-source-map",
        stats: {
            depth: false,
            hash: false,
            modules: false,
