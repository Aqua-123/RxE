...
const makeMention = (mention: string) => mention
    ? <b style={App.user.flair}>{mention}</b> : null
...
export function init() {
    ...
    Message.prototype.process = function process(message: string) {
        ...
        const messageContent = wrapStringPartitions(message, name, makeMention, processOld);
